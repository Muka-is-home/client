export const FooterData = {
  ...
  col2: {
    ...
    children: [
      ...
      { title: "Facebook", link: "https://www.facebook.com/mukaishome" },
    ],
  },
  col3: {
    title: "Useful Links",
    children: [
      ...
      { title: "Become a Muka Vendor", link: `${process.env.NEXT_PUBLIC_URL}/adminapp/signup` },
      { title: "Contact", link: "/contact" },
    ],
  },
  sub_footer: [ // find icons at font-awesome icons
    { link: "https://www.facebook.com/mukaishome", class: "fab fa-facebook-f" },
